...
from Champu import application, registered_users,SUPPORT_CHAT
...
from Champu import SUDOERS_collection, user_collection
...
async def pay(update, context):
    ...
    keyboard = [[InlineKeyboardButton("APPEAL", url=f'https://t.me/TheChampuClub')]]
...
async def mtop(update, context):
    ...
    top_users_message += "────────────────────\nTop 10 Wealthy Users via @itsWaifuBot"
...
async def reset_tokens(update, context):
    owner_id = 7006524418  # Replace with the actual owner's user ID
