...
from Champu import user_collection, Champuu

pending_trades = {}


@Champuu.on_message(filters.command("trade"))
...
@Champuu.on_callback_query(filters.create(lambda _, __, query: query.data in ["confirm_trade", "cancel_trade"]))
...
@Champuu.on_message(filters.command("gift"))
...
@Champuu.on_callback_query(filters.create(lambda _, __, query: query.data in ["confirm_gift", "cancel_gift"]))
async def on_callback_query(client, callback_query):
