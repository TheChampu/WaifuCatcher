...
from Champu import application, LOGGER, TOKEN 
from Champu import set_on_data, set_off_data
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Champu.modules." + module_name)
...
def main() -> None:
    ...
    if not TOKEN:
        LOGGER.error("Environment variables TOKEN  are not set")
        return
    # Set the webhook URL
    WEBHOOK_URL = f"{TOKEN}"
