...
[![Support Group!](https://img.shields.io/badge/Join%20Group-↗-green)](https://t.me/ShivanshuHUB)
...
### Heroku
- Fork The Repository
- Go to [`config.py`](./Champu/config.py)
- Fill the All variables and Go to heroku. and deploy Your forked Repository

### Local Deploy/VPS
- Fill variables in [`config.py`](./Champu/config.py) 
...
git clone https://github.com/<YourUsername>/WaifuCatcher && cd WaifuCatcher
